...
handle_callback_info(Message, #state{module=Module
    ...
    _ = stop_timer(OldRef),
    %%lager:debug("HueT: handle_info: Module: ~p; ~n; Message: ~p ~n",[Module, Message]),
...
handle_module_call(Request, From, #state{module=Module
    ...
    _ = stop_timer(OldRef),
    %%lager:debug("HueT: handle_call: handle_module_call: Module: ~p ~n; Request:~p ~n; From: ~p ~n",
    %%%						[Module, Request, From]),
...
handle_module_cast(Msg, #state{module=Module
    ...
    stop_timer(OldRef),
    %%lager:debug("HueT: handle_cast: handle_module_cast: Module:~p ~n; Msg: ~p ~n",
    %%						[Module, Msg]),
